...
from .update import Source, State, Updater
...
def _cmd_verify(args: argparse.Namespace) -> int:
    public = keys.public_from_text(args.pub.read_text(encoding="ascii"))
...
def _updater(args: argparse.Namespace) -> Updater:
    public_text = args.pub.read_text(encoding="ascii")
    return Updater(Source(args.repo), args.dest, public_text)
